  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_line() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, expr, children) { return {expr:expr, children: children === "" ? [] : children}; })(pos0, result0[1], result0[3]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_statement() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, v, expr) { return { tag:"set", left:v, right:expr }; })(pos0, result0[0], result0[4]);
        }
        if (result0 === null) {
          pos = pos0;
        }
        if (result0 === null) {
          ...
          if (result0 === null) {
            ...
            if (result0 === null) {
              ...
              if (result0 !== null) {
                result0 = (function(offset, expr) { return { tag:"if", body:expr}; })(pos0, result0[2]);
              }
              if (result0 === null) {
                pos = pos0;
              }
              if (result0 === null) {
                ...
                if (result0 !== null) {
                  result0 = (function(offset, expr) { return { tag:"repeat", body:expr}; })(pos0, result0[2]);
                }
                if (result0 === null) {
                  pos = pos0;
                }
